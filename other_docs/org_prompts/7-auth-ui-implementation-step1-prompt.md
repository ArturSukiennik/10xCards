Twoim zadaniem jest implementacja elementów interfejsu użytkownika (stron i formularzy) dla procesu logowania, rejestracji, wylogowania i resetowania hasła. Specyfikacja znajduje się w: .ai/auth-spec.md
