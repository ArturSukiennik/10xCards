...
1. Automatyczne generowanie fiszek:
   ...
   - Użytkownik wkleja dowolny tekst (np. fragment podręcznika) (rozmiar tekstu od 1000 znaków do 10000 znaków).
...
2. Ręczne tworzenie i zarządzanie fiszkami:
   ...
   - Formularz do ręcznego tworzenia fiszek (przód (maksymalnie 200 znaków) i tył fiszki (maksymalnie 600 znaków)).
